...
public class UserConvert {
     ...
     * @return 登录响应DTO
     */
    public static UserLoginResponseDTO entityToDetailResponse(String token, UserLoginResponseDTO.UserDetailResponseDTO userInfo) {
    ...
    public static User registerCommandToEntity(UserRegisterCommandDTO command, String encodedPassword) {
        return User.builder()
